    ...
    >
      ...
      <template v-else>
        ...
        >
          <Skeleton
            variant="rect"
            style="width:100%; aspect-ratio:120/52; border-radius:6px;"
          />
          <Skeleton
            variant="text"
            width="80px"
    ...
    >
      ...
      <div class="settings-card">
        <div class="card-header">
          ...
          <p class="card-desc">
            Choose how the top of your invoice looks.
          </p>
        </div>
        <div class="card-body">
          <div class="header-layout-grid">
            ...
            >
              <div class="header-layout-preview">
                ...
                <!-- Centered -->
                <svg
                  v-else-if="layout.value === 'centered'"
                  viewBox="0 0 120 52"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <!-- Minimal -->
                <svg
                  v-else-if="layout.value === 'minimal'"
                  viewBox="0 0 120 52"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <!-- Professional -->
                <svg
                  v-else-if="layout.value === 'professional'"
                  viewBox="0 0 120 52"
                  fill="none"
                >
                  <rect
              ...
              <div class="header-layout-label">
                {{ layout.label }}
              </div>
              <div class="header-layout-desc">
                {{ layout.desc }}
              </div>
              <div
                v-if="draft.header_layout === layout.value"
                class="header-layout-check"
              >
                <svg
                  width="14"
                  height="14"
          ...
          <div class="color-row">
            <div class="color-field">
              ...
              <div class="color-input-wrap">
                <div
                  class="color-swatch"
                  :style="{ background: draft.header_text_color }"
                />
                <span class="color-hex">{{ draft.header_text_color }}</span>
                <input
                  v-model="draft.header_text_color"
                  type="color"
                  class="color-picker"
                >
              </div>
            ...
            <div class="color-field">
              ...
              <div class="color-input-wrap">
                <div
                  class="color-swatch"
                  :style="{ background: draft.body_text_color }"
                />
                <span class="color-hex">{{ draft.body_text_color }}</span>
                <input
                  v-model="draft.body_text_color"
                  type="color"
                  class="color-picker"
                >
              </div>
          ...
          <div class="field-row">
            <div class="field">
              ...
              <div
                ...
                :style="{ fontSize: draft.company_font_size + 'px', fontFamily: draft.font_family }"
              >
                Your Business Name
              </div>
            </div>
