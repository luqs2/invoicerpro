...
export const useBusinessProfileStore = defineStore('businessProfile', () => {
  ...
  async function fetch() {
    ...
    const { data } = await supabase
      ...
      .select('id, user_id, name, email, phone, address, logo_url, default_currency, default_tax_rate, invoice_prefix, receipt_prefix, next_invoice_number, next_receipt_number, active_template_id, terms_text')
