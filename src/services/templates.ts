...
export const templateService = {
  async getAll(userId: string) {
    ...
    return supabase
      ...
      .select('id, user_id, name, is_system, primary_color, secondary_color, accent_color, header_text_color, body_text_color, font_family, border_radius, header_layout, company_font_size, logo_position, show_bank_details, show_line_item_date, show_line_item_vehicle_no, show_line_item_uom, footer_text, terms_text, created_at')
