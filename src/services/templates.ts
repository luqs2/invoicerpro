...
export const templateService = {
  async getAll(userId: string) {
    ...
    return supabase
      ...
      .select('id, user_id, name, is_system, primary_color, secondary_color, accent_color, font_family, border_radius, logo_position, show_bank_details, footer_text, created_at')
